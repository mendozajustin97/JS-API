...
//     popupWindow =
//     window.open(url, 'popUpwindow', 'height=200, width=200,left=100,top=100,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no, statues=yes')
// }
